...
export const SidebarProvider = ({ children }) => {
  ...
  const [activeSidebarItem, setActiveSidebarItem] = useState('Dashboard');
  const [activeDropdownItem, setActiveDropdownItem] = useState(null);
  const [activeMainMenuItem, setActiveMainMenuItem] = useState('Dashboard'); // ← YEH LINE ADD KAREIN
  ...
  const value = {
    ...
    activeSidebarItem,
    activeDropdownItem,
    activeMainMenuItem, // ← YEH ADD KAREIN
    setActiveMainMenuItem, // ← YEH ADD KAREIN
    toggleSidebar,
    toggleMobileSidebar,
    closeMobileSidebar,
    handleMouseEnter,
