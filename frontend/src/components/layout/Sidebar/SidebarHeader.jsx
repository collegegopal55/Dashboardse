...
//   return (
//     <div className={`p-2 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'} flex-shrink-0`}>
...
const SidebarHeader = () => {
  ...
  return (
    <div className={`p-2 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'} bg-inherit`}>
      <div className="flex items-center justify-between">
        {(!isMobile && sidebarCollapsed) ? (
          <div className="w-10 h-10 rounded-lg overflow-hidden mx-auto">
            <img 
